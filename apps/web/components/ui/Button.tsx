...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      primary: 'bg-primary text-white hover:bg-primary-hover shadow-cosmic hover:shadow-glow',
      secondary: 'bg-secondary text-cosmic-void hover:bg-secondary/90',
      outline: 'border-2 border-primary text-primary hover:bg-primary hover:text-white',
      ghost: 'text-foreground hover:bg-cosmic-deep',
